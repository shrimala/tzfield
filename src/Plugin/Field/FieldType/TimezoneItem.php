...
class TimezoneItem extends FieldItemBase {
  ...
  public function getConstraints() {
    ...
    $constraints[] = $constraint_manager->create('ComplexData', array(
      'value' => array(
        'Length' => array(
          'max' => $max_length,
          'maxMessage' => t('%name: the time zone name may not be longer than @max characters.', array('%name' => $this->getFieldDefinition()->getLabel(), '@max' => $max_length)),
        )
      ),
    ));
  ...
  public static function generateSampleValue(FieldDefinitionInterface $field_definition) {
    $values['value'] = \DateTimeZone::listIdentifiers()[array_rand(\DateTimeZone::listIdentifiers())];
    return $values;
  }
